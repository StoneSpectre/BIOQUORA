...
import { Droplet, Info, Search, Database, BookOpen, Activity, ArrowRight, Loader2, BrainCircuit, Waves } from "lucide-react";
...
const Hepatic = () => {
  ...
  const [pubmedQuery, setPubmedQuery] = useState("Liver Cirrhosis Pathology");
  const [pubmedResults, setPubmedResults] = useState<PubMedArticle[]>([]);
  const [isSearchingPubMed, setIsSearchingPubMed] = useState(false);

  const [clinicalQuery, setClinicalQuery] = useState("Cirrhosis");
      ...
      <div className="container py-8 sm:py-12">
        ...
        <div className="mb-8 sm:mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-2xl sm:text-3xl font-semibold">Hepatic Intelligence</h1>
          </div>
          <p className="text-lg text-muted-foreground max-w-3xl">
            Explore liver physiology, metabolism, and pathologies like Cirrhosis and Hepatitis through interactive research data.
          </p>
        </div>
        ...
        <Tabs defaultValue="explorer" className="w-full">
          ...
          <TabsContent value="simulation" className="animate-fade-in">
            <Card className="p-12 border-border/60 shadow-sm flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Hepatic Simulation Under Development</h3>
              <p className="text-muted-foreground">Interactive portal hypertension models are coming in the next update.</p>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="research" className="space-y-6 animate-fade-in">
            <div className="flex gap-4 mb-8 bg-muted/30 p-2 rounded-lg border border-border/50">
              <div className="relative flex-1 flex items-center">
                ...
                <input 
                  type="text" 
                  placeholder="Search hepatic literature..." 
