"""
bioquora/nlp/pipeline/ner_pipeline.py
──────────────────────────────────────
Steps 1 & 2 of the Bioquora NLP Layer.
...
from bioquora.nlp.models.schemas import ExtractedEntity, EntityLink, NLPResult, ProcessRequest
from bioquora.nlp.pipeline.model_loader import get_model_registry

logger = logging.getLogger(__name__)

# Maps scispaCy / rule-based labels → canonical Bioquora label set
LABEL_MAP = {
