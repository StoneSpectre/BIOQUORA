"""
BIOQUORA - Investors Pitch Deck Updater
Backs up the existing 'Investors Pitch Deck.pptx' to 'Investors Pitch Deck.backup.pptx'
and generates a state-of-the-art 12-slide Widescreen Pitch Deck at 'Investors Pitch Deck.pptx'
updated with BIOQUORA Step 3 (v1.0.0-PROD) architecture, BKOS standard, benchmarks, and business model.
"""
...
def update_pitch_deck():
    target_file = os.path.join(os.getcwd(), "Investors Pitch Deck.pptx")
    backup_file = os.path.join(os.getcwd(), "Investors Pitch Deck.backup.pptx")

    if os.path.exists(target_file):
        shutil.copy2(target_file, backup_file)
        print(f"[BACKUP] Created backup of original deck at: {backup_file}")
    ...
    def add_footer(slide, footer_text="BIOQUORA PLATFORM -- INVESTORS PITCH DECK | STEP 3 FROZEN (v1.0.0-PROD)"):
    ...
    add_bg(s1)
    tx1 = s1.shapes.add_textbox(Inches(1.0), Inches(1.8), Inches(11.3), Inches(4.0))
    tf1 = tx1.text_frame
    tf1.word_wrap = True
    p0 = tf1.paragraphs[0]
    p0.text = "BIOQUORA"
    p0.font.size = Pt(64); p0.font.bold = True; p0.font.color.rgb = WHITE
    p1 = tf1.add_paragraph()
    p1.text = "Autonomous Biomedical Literature Intelligence & Knowledge Graph Platform"
    p1.font.size = Pt(24); p1.font.color.rgb = CYAN_ACCENT; p1.space_before = Pt(16)
    ...
    p2.font.size = Pt(16); p2.font.color.rgb = LIGHT_GRAY; p2.space_before = Pt(24)
    add_footer(s1, "INVESTORS PITCH DECK | ARCHITECTURE STATUS: STEP 3 FROZEN (v1.0.0-PROD) -> STEP 4 KG")

    # 2. PROBLEM STATEMENT
    s2 = prs.slides.add_slide(blank_layout)
    add_header(s2, 2, "The $2.5B Biomedical Knowledge Crisis")
    add_card(s2, Inches(0.8), Inches(1.7), Inches(3.7), Inches(4.6),
             "1. Exponential Literature",
             ["Over 4,000 new biomedical papers published daily across PubMed, PMC, and bioRxiv.",
              "Researchers can read less than 0.1% of literature relevant to their specialty."],
             CYAN_ACCENT)
    add_card(s2, Inches(4.8), Inches(1.7), Inches(3.7), Inches(4.6),
             "2. Locked & Uncomputable",
             ["Critical mechanistic facts, drug targets, and adverse event pathways are trapped inside static PDFs.",
              "Complex multi-column tables and visual figures remain unqueriable."],
             CYAN_ACCENT)
    add_card(s2, Inches(8.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             RGBColor(255, 82, 82))
    add_footer(s2, "IMPACT: Over $2.5B+ and 10-12 years required to bring a single therapeutic drug to market.")

    # 3. MARKET VALIDATION
    s3 = prs.slides.add_slide(blank_layout)
    add_header(s3, 3, "Market Validation & $100B+ Opportunity")
    add_card(s3, Inches(0.8), Inches(1.7), Inches(3.7), Inches(4.6),
             "$102 Billion TAM",
             ...
             GREEN_ACCENT)
    add_card(s3, Inches(4.8), Inches(1.7), Inches(3.7), Inches(4.6),
             "$24.5 Billion SAM",
             ...
             CYAN_ACCENT)
    add_card(s3, Inches(8.8), Inches(1.7), Inches(3.7), Inches(4.6),
             "10,000+ Target Labs",
             ...
             WHITE)
    add_footer(s3, "MARKET VALIDATION: Proven by rapid enterprise adoption of scientific NLP and knowledge graph reasoning.")

    # 4. SOLUTION
    s4 = prs.slides.add_slide(blank_layout)
    add_header(s4, 4, "The BIOQUORA Solution")
    add_card(s4, Inches(0.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             CYAN_ACCENT)
    add_card(s4, Inches(4.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             GREEN_ACCENT)
    add_card(s4, Inches(8.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             CYAN_ACCENT)
    add_footer(s4, "RESULT: Transforming static unstructured literature into computable biomedical knowledge.")

    # 5. INNOVATION & ARCHITECTURE
    s5 = prs.slides.add_slide(blank_layout)
    add_header(s5, 5, "6-Stage Neuro-Symbolic Architecture")
    add_card(s5, Inches(0.8), Inches(1.7), Inches(5.6), Inches(4.6),
             ...
             CYAN_ACCENT)
    add_card(s5, Inches(6.8), Inches(1.7), Inches(5.6), Inches(4.6),
             ...
             GREEN_ACCENT)
    add_footer(s5, "ENGINEERING STATUS: 264 Production Files & 14,500+ Lines of Verified Python Live on GitHub.")

    # 6. CANONICAL BKOS STANDARD
    s6 = prs.slides.add_slide(blank_layout)
    add_header(s6, 6, "Canonical BKOS Standard (v1.0)")
    add_card(s6, Inches(0.8), Inches(1.7), Inches(5.4), Inches(4.6),
             ...
             CYAN_ACCENT)
    add_card(s6, Inches(6.6), Inches(1.7), Inches(5.9), Inches(4.6),
             ...
             GREEN_ACCENT)
    add_footer(s6, "EXPORT LAYER: Automatically emits Neo4j CSV Nodes/Edges, W3C RDF/Turtle (.ttl), and JSON Graph Triples.")

    # 7. SCIENTIFIC BENCHMARKS
    s7 = prs.slides.add_slide(blank_layout)
    add_header(s7, 7, "Scientific Benchmarks & Validation")
    add_card(s7, Inches(0.8), Inches(1.7), Inches(3.7), Inches(4.6),
             "0.924 NER F1 Score",
             ...
             GREEN_ACCENT)
    add_card(s7, Inches(4.8), Inches(1.7), Inches(3.7), Inches(4.6),
             "0.912 BioASQ QA F1",
             ...
             CYAN_ACCENT)
    add_card(s7, Inches(8.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             WHITE)
    add_footer(s7, "CERTIFICATION: Step 3 officially certified BioReady v1.0.0-PROD with Quality Score >= 0.98.")

    # 8. BUSINESS MODEL
    s8 = prs.slides.add_slide(blank_layout)
    add_header(s8, 8, "Scalable B2B Business Model")
    add_card(s8, Inches(0.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             CYAN_ACCENT)
    add_card(s8, Inches(4.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             GREEN_ACCENT)
    add_card(s8, Inches(8.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             WHITE)
    add_footer(s8, "RETENTION: High recurring revenue via mission-critical integration into biopharma R&D workflows.")

    # 9. TECHNICAL FEASIBILITY
    s9 = prs.slides.add_slide(blank_layout)
    add_header(s9, 9, "Feasibility & Production Hardening")
    add_card(s9, Inches(0.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             GREEN_ACCENT)
    add_card(s9, Inches(4.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             CYAN_ACCENT)
    add_card(s9, Inches(8.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             WHITE)
    add_footer(s9, "STATUS: Architecture locked as v1.0.0-PROD ready for enterprise scale.")

    # 10. IMPACT
    s10 = prs.slides.add_slide(blank_layout)
    add_header(s10, 10, "Industry & Societal Impact")
    add_card(s10, Inches(0.8), Inches(1.7), Inches(3.7), Inches(4.6),
             "Drug Repurposing",
             ...
             CYAN_ACCENT)
    add_card(s10, Inches(4.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             GREEN_ACCENT)
    add_card(s10, Inches(8.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             WHITE)
    add_footer(s10, "CORE BELIEF: Scientific knowledge creates value only when it reaches society.")

    # 11. ROADMAP
    s11 = prs.slides.add_slide(blank_layout)
    add_header(s11, 11, "Future Roadmap: Step 4 & Beyond")
    add_card(s11, Inches(0.8), Inches(1.7), Inches(3.7), Inches(4.6),
             "Q3 2026 (Current)",
             ...
             GREEN_ACCENT)
    add_card(s11, Inches(4.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             CYAN_ACCENT)
    add_card(s11, Inches(8.8), Inches(1.7), Inches(3.7), Inches(4.6),
             ...
             WHITE)
    add_footer(s11, "NEXT STAGE: Step 4 Biomedical Knowledge Graph (BioKG) Master Ingestion.")

    # 12. VISION & CALL TO ACTION
    s12 = prs.slides.add_slide(blank_layout)
    add_bg(s12)
    tx12 = s12.shapes.add_textbox(Inches(1.0), Inches(1.8), Inches(11.3), Inches(4.5))
    tf12 = tx12.text_frame
    tf12.word_wrap = True
    p0 = tf12.paragraphs[0]
    p0.text = "\"Scientific knowledge creates value only when it reaches society.\""
    p0.font.size = Pt(36); p0.font.bold = True; p0.font.color.rgb = CYAN_ACCENT
    ...
    p1.font.size = Pt(20); p1.font.color.rgb = WHITE; p1.space_before = Pt(24)
    ...
    p2.font.size = Pt(18); p2.font.color.rgb = GREEN_ACCENT; p2.space_before = Pt(32)
    add_footer(s12, "THANK YOU -- BIOQUORA PLATFORM ENGINEERING TEAM | v1.0.0-PROD")

    prs.save(target_file)
    print(f"[SUCCESS] Updated 'Investors Pitch Deck.pptx' (12 Widescreen Slides): {target_file}")
