...
let content = fs.readFileSync('src/pages/BioquoraPhase.tsx', 'utf8');
...
fs.writeFileSync('src/pages/BioquoraPhase.tsx', content, 'utf8');
console.log("Successfully updated BioquoraPhase.tsx with phase tabs and new steps.");
