...
with open("src/pages/BioquoraPhase.tsx", "r", encoding="utf-8") as f:
    content = f.read()

# The component starts at "export default function BioquoraDashboard()"
component_split = content.find("export default function BioquoraDashboard()")
...
with open("src/pages/BioquoraPhase.tsx", "w", encoding="utf-8") as f:
    f.write(new_data + component_code)

print("Rewrote BioquoraPhase.tsx successfully.")
