...
const steps = [
  ...
  },
  {
    ...
    deliverable: "BIOQUORA Biomedical Intelligence Platform",
    flow: ["PubMed+PMC+PhysioNet+MIMIC-IV", "NCBI APIs", "scispaCy", "BioBERT", "PubMedBERT", "Neo4j", "NetworkX", "FAISS", "LlamaIndex", "LangChain", "GraphRAG", "BIOQUORA"],
    isFinal: true,
  },
];
