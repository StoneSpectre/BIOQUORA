...
from bioquora.step8_research_copilot.agents.evidence_agent import EvidenceDoc
...
_SYSTEM_PROMPT = """
You are the Writer Agent for Bioquora, a biomedical research intelligence platform.
