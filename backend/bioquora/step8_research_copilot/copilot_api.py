...
from bioquora.step8_research_copilot.agents.planner_agent import PlannerAgent
from bioquora.step8_research_copilot.agents.retrieval_agent import RetrievalAgent
from bioquora.step8_research_copilot.agents.graph_agent import GraphAgent
from bioquora.step8_research_copilot.agents.evidence_agent import EvidenceAgent
from bioquora.step8_research_copilot.agents.writer_agent import WriterAgent
from bioquora.step8_research_copilot.orchestrator import CopilotOrchestrator
from bioquora.step8_research_copilot.memory.session_memory import SessionMemory
from bioquora.step8_research_copilot.workspace.workspace_service import WorkspaceService
...
async def lifespan(app: FastAPI):
    # ── Startup ───────────────────────────────────────────────────────────────
    import os
    postgres_dsn = os.getenv("POSTGRES_DSN", "postgresql://user:pass@localhost:5432/bioquora")
    ...
    retrieval = RetrievalAgent(
        ...
        qdrant_collection=os.getenv("QDRANT_COLLECTION", "bioquora_docs"), postgres_dsn=postgres_dsn,
    )
