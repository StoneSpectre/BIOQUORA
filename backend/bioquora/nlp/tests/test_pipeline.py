"""
bioquora/nlp/tests/test_pipeline.py
────────────────────────────────────
Test suite for Steps 1 & 2 of the Bioquora NLP Layer.
...
Run with:
  cd /home/claude && python -m pytest bioquora/nlp/tests/ -v
"""
...
from bioquora.nlp.pipeline.ner_pipeline import (
    process_text,
    _normalise_label,
    _merge_entities,
    SUPPORTED_LABELS,
