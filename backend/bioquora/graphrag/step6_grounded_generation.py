"""
Bioquora GraphRAG — Step 6: Transparent Citation-Grounded Generation
=====================================================================
...
GENERATION_SYSTEM_PROMPT = """You are Bioquora, a biomedical evidence assistant.
...
class ReportAssembler:
    def assemble(self, query: str, answer: StructuredAnswer) -> str:
        lines = [f"# Bioquora Research Answer\n", f"**Question:** {query}\n"]
